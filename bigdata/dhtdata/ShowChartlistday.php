...
<?php
 // http://nuk.arduino.org.tw:8888/dhtdata/ShowChartlistday.php?MAC=E89F6DE8F3BC&dt1=20200101&dt2=20221231	
	...
	$qry ="select MAC, left(systime,8) as systime, avg(temperature) as temperature, avg(humidity) as humidity from big.dhtdata where MAC = '%s' and systime >= '%s' and systime <= '%s' group by left(systime,8) order by systime asc " ;		//將dhtdata的資料找出來
