...
<?php
	...
	//SELECT * FROM big.dhtdata where mac = 'CC50E38CEE18' order by systime desc limit 1
	$qrystr=sprintf("SELECT * FROM big.dhtdata where mac = '%s' order by systime desc limit 1 ",$mid) ;		//將dhtdata的資料找出來
